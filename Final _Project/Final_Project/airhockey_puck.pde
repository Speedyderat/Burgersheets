...
// handles the physics of the puck and the launching at the start and after scoring.
...
class Puck {
  ...
  void run() {
    //puck when starting off (before puckState 2, when interaction with the mouse is happening)
  ...
  void reset() {                                                                                          //sets the puck state to zero after each goal is scored
    puckState = 0;
  }
